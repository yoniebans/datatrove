...
uv pip install transformers ray psutil numpy packaging pyzmq fastapi uvicorn sentencepiece aiohttp gguf blake3 cachetools msgspec pybase64 einops cloudpickle
